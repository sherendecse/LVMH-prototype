...
const questions = [
  {
    ...
    example: "Example: an office meeting, wedding dinner, graduation, or night out.",
    optional: false
  },
  {
    key: "skinType" as const,
    title: "How would you describe your skin type?",
    example: "Example: oily, dry, combination, balanced, or sensitive.",
    optional: false
  },
  {
    key: "boldness" as const,
    title: "How bold or natural should the final look be?",
    example: "Example: very natural, polished soft glam, elegant, or bold and dramatic.",
    optional: false
  },
  {
    key: "avoid" as const,
    title: "Is there anything you want to avoid?",
    example: "Example: shimmer, matte foundation, berry lipstick, fragrance, or glitter.",
    optional: true
  }
];
